...
- Developed SQL scripts to build a monitoring dashboard with Google internal tools, enhancing maintainability and transparency in data quality enforcement.
## Tools: 
- C++, SQL, Protocol Bufffers
